...
int main(int argc, char **argv) {
    if (argc < 3) {
        ...
        pcl::console::print_info(
            "    --objects_root_path root_path ......... Root path to append "
            "to files in object_files.txt \n");
        pcl::console::print_info("    --objects object_files.txt ......... A "
                                 "list of the files to use as exemplars\n");
    ...
    pcl::console::parse_argument(argc, argv, "--objects_root_path",
                                 objects_root_path);
    ...
    if (input_stream.is_open()) {
        while (input_stream.good()) {
            ...
            if (filename.size() > 0) {
                exemplar_filenames.push_back(objects_root_path + "/" +
                                             filename);
            }
        }
        input_stream.close();
