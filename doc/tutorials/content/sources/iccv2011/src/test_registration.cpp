...
int main(int argc, char **argv) {
    if (argc < 3) {
        ...
        pcl::console::print_info(
            "    -i min_sample_dist,max_dist,nr_iters ................ Compute "
            "initial alignment\n");
        pcl::console::print_info(
            "    -r max_dist,rejection_thresh,tform_eps,max_iters "
            "............. Refine alignment\n");
        pcl::console::print_info(
            "    -s output.pcd ........................... Save the registered "
            "and merged clouds\n");
        pcl::console::print_info("Note: The inputs (source and target) must be "
    ...
    bool compute_intial_alignment =
        pcl::console::parse_3x_arguments(argc, argv, "-i", min_sample_dist,
                                         max_correspondence_dist, nr_iters) > 0;
    ...
    if (refine_alignment) {
        ...
        tform = refineAlignment(src_points, tgt_points, tform,
    ...
    std::string filename;
    bool save_output =
        pcl::console::parse_argument(argc, argv, "-s", filename) > 0;
    if (save_output) {
    ...
    // Or visualize the result
        ...
        pcl::visualization::PointCloudColorHandlerCustom<PointT> red(src_points,
                                                                     255, 0, 0);
