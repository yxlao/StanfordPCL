...
void find_feature_correspondences(
...
void visualize_correspondences(const PointCloudPtr points1,
    ...
    // copies of the clouds and transform them by shifting one to the left and
    // the other to the right.  Then we'll draw lines between the corresponding
    // points
...
int main(int argc, char **argv) {
    ...
    find_feature_correspondences(source_descriptors, target_descriptors,
                                 correspondences, correspondence_scores);

    visualize_correspondences(source_points, source_keypoints, target_points,
                              target_keypoints, correspondences,
                              correspondence_scores, nr_correspondences);
