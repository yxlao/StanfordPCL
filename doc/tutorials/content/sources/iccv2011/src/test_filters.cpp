...
int main(int argc, char **argv) {
    if (argc < 2) {
        ...
        pcl::console::print_info("    -r radius,min_neighbors ............... "
    ...
    bool threshold_depth = pcl::console::parse_2x_arguments(
                               argc, argv, "-t", min_depth, max_depth) > 0;
    if (threshold_depth) {
        size_t n = cloud->size();
    ...
    bool remove_outliers = pcl::console::parse_2x_arguments(
                               argc, argv, "-r", radius, min_neighbors) > 0;
    if (remove_outliers) {
        size_t n = cloud->size();
