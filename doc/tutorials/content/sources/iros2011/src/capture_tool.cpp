...
int main(int argc, char **argv) {
    if (argc < 2) {
        ...
        pcl::console::print_info("  Note: The output filename should be "
                                 "provided without the .pcd extension.\n");
        pcl::console::print_info("        File names will have frame numbers "
                                 "and extension appended to them.\n");
        pcl::console::print_info("        (e.g., 'output' will become "
                                 "'output_1.pcd', 'output_2.pcd', etc.)\n");
        return (1);
    }
