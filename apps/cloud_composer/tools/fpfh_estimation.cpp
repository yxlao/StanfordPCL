...
Q_EXPORT_PLUGIN2(cloud_composer_fpfh_estimation_tool,
...
pcl::cloud_composer::FPFHEstimationTool::performAction(
    ...
    if (input_item->type() == CloudComposerItem::CLOUD_ITEM) {
        ...
        // Create the FPFH estimation class, and pass the input dataset+normals
        // to it
        ...
        //////////////////////////////////////////////////////////////////
        FPFHItem *fpfh_item =
            new FPFHItem(tr("FPFH r=%1").arg(radius), fpfhs, radius);
...
pcl::cloud_composer::FPFHEstimationToolFactory::createToolParameterModel(
    ...
    parameter_model->addProperty("Radius", 0.03,
