...
Q_EXPORT_PLUGIN2(cloud_composer_normal_estimation_tool,
...
pcl::cloud_composer::NormalEstimationTool::performAction(
    ...
    if (input_data.size() == 0) {
        ...
        qWarning()
            << "Input vector has more than one item in Normal Estimation!";
    }
    ...
    if (input_item->type() == CloudComposerItem::CLOUD_ITEM) {
        ...
        //////////////////////////////////////////////////////////////////
        NormalsItem *normals_item = new NormalsItem(
            tr("Normals r=%1").arg(radius), cloud_normals, radius);
...
pcl::cloud_composer::NormalEstimationToolFactory::createToolParameterModel(
    ...
    parameter_model->addProperty("Radius", 0.02,
