...
Q_EXPORT_PLUGIN2(cloud_composer_voxel_grid_downsample_tool,
...
pcl::cloud_composer::VoxelGridDownsampleTool::performAction(
    ...
    if (input_data.size() == 0) {
        ...
        qWarning()
            << "Input vector has more than one item in VoxelGridDownsampleTool";
    }
