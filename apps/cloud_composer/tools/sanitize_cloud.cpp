...
Q_EXPORT_PLUGIN2(cloud_composer_sanitize_cloud_tool,
...
pcl::cloud_composer::SanitizeCloudTool::performAction(
    ...
    if (input_item->type() == CloudComposerItem::CLOUD_ITEM) {
        ...
        bool keep_organized =
            parameter_model_->getProperty("Keep Organized").toBool();
