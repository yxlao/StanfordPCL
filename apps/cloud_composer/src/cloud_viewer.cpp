...
void pcl::cloud_composer::CloudViewer::addModel(ProjectModel *new_model) {
...
void pcl::cloud_composer::CloudViewer::addNewProject(ProjectModel *new_model) {
...
void pcl::cloud_composer::CloudViewer::modelChanged(int index) {
