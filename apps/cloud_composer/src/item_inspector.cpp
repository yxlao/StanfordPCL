...
void pcl::cloud_composer::ItemInspector::setModel(ProjectModel *new_model) {
...
void pcl::cloud_composer::ItemInspector::selectionChanged(
...
void pcl::cloud_composer::ItemInspector::storeTreeState() {
...
void pcl::cloud_composer::ItemInspector::restoreTreeState() {
...
void pcl::cloud_composer::ItemInspector::itemChanged(QStandardItem *) {}

void pcl::cloud_composer::ItemInspector::removeTabs() {
    clear();
    addTab(parameter_view_, "Parameters");
}

void pcl::cloud_composer::ItemInspector::updateView() {
    ...
    if (model) {
        cloud_item = dynamic_cast<CloudComposerItem *>(
            model->itemFromIndex(current_item));
        if (cloud_item) {
            current_item_properties_model_ =
                cloud_item->data(ItemDataRole::PROPERTIES)
