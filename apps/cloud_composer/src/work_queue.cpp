...
void pcl::cloud_composer::WorkQueue::enqueueNewAction(
    AbstractTool *new_tool, ConstItemList input_data) {
...
void pcl::cloud_composer::WorkQueue::actionFinished(
    ActionPair finished_action) {
...
void pcl::cloud_composer::WorkQueue::checkQueue() {
