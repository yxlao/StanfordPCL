 ...
 * list of classes. Available features: ESF, VFH, CVFH \author Aitor Aldoma
 */
...
class PCL_EXPORTS GlobalNNCRHRecognizer {
  ...
  protected:
    ...
    typename boost::shared_ptr<CRHEstimation<PointInT, FeatureT>>
        crh_estimator_;
    ...
    void getCRH(ModelT &model, int view_id, int d_id, CRHPointCloud::Ptr &hist);
  ...
  public:
    ...
    void setDOCRH(bool b) { do_CRH_ = b; }
    ...
    void setFeatureEstimator(
        typename boost::shared_ptr<CRHEstimation<PointInT, FeatureT>> &feat) {
        crh_estimator_ = feat;
    }
