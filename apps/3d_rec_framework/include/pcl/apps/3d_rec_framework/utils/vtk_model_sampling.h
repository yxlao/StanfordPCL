...
inline void randomPointTriangle(double a1, double a2, double a3, double b1,
                                double b2, double b3, double c1, double c2,
                                double c3, Eigen::Vector4f &p) {
...
inline void randPSurface(vtkPolyData *polydata,
    ...
    randomPointTriangle(A[0], A[1], A[2], B[0], B[1], B[2], C[0], C[1], C[2],
                        p);
}

template <typename PointT>
inline void uniform_sampling(vtkSmartPointer<vtkPolyData> polydata,
                             size_t n_samples,
...
template <typename PointT>
inline void uniform_sampling(std::string &file, size_t n_samples,
                             typename pcl::PointCloud<PointT> &cloud_out,
                             float scale = 1.f) {
...
inline void getVerticesAsPointCloud(vtkSmartPointer<vtkPolyData> polydata,
