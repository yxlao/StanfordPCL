...
inline bool writeCentroidToFile(std::string file, Eigen::Vector3f &centroid) {
...
inline bool writeMatrixToFile(std::string file, Eigen::Matrix4f &matrix) {
    std::ofstream out(file.c_str());
    if (!out) {
        std::cout << "Cannot open file.\n";
        return false;
...
inline bool writeFloatToFile(std::string file, float value) {
    std::ofstream out(file.c_str());
    if (!out) {
        std::cout << "Cannot open file.\n";
        return false;
...
inline std::string getViewId(std::string id) {
...
inline bool readFloatFromFile(std::string dir, std::string file, float &value) {
...
inline bool readFloatFromFile(std::string file, float &value) {
...
inline bool readMatrixFromFile(std::string dir, std::string file,
    ...
    std::stringstream matrix_file;
    matrix_file << file_replaced << id << "/" << dname << "/pose_"
                << getViewId(file) << ".txt";
...
inline bool readMatrixFromFile2(std::string file, Eigen::Matrix4f &matrix) {
...
getPointCloudFromFile(std::string dir, std::string file,
    ...
    view_file << file_replaced << id << "/" << dname << "/view_"
              << getViewId(file) << ".pcd";
