...
template class pcl::rec_3d_framework::GlobalNNCRHRecognizer<
    flann::L2, pcl::PointXYZ, pcl::VFHSignature308>;
template class pcl::rec_3d_framework::GlobalNNCRHRecognizer<
    flann::L1, pcl::PointXYZ, pcl::VFHSignature308>;
template class pcl::rec_3d_framework::GlobalNNCRHRecognizer<
...
template class pcl::rec_3d_framework::GlobalNNCRHRecognizer<
    flann::L1, pcl::PointXYZ, pcl::ESFSignature640>;
template class pcl::rec_3d_framework::GlobalNNCRHRecognizer<
    flann::L2, pcl::PointXYZ, pcl::ESFSignature640>;
