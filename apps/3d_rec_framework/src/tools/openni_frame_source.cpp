...
bool OpenNIFrameSource::isActive() { return active_; }

const PointCloudPtr OpenNIFrameSource::snap() { return (most_recent_frame_); }
...
void OpenNIFrameSource::onKeyboardEvent(
