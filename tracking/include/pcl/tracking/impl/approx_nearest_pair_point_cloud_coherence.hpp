...
void ApproxNearestPairPointCloudCoherence<PointInT>::computeCoherence(
...
template <typename PointInT>
bool ApproxNearestPairPointCloudCoherence<PointInT>::initCompute() {
...
#define PCL_INSTANTIATE_ApproxNearestPairPointCloudCoherence(T)                \
    template class PCL_EXPORTS                                                 \
        pcl::tracking::ApproxNearestPairPointCloudCoherence<T>;
