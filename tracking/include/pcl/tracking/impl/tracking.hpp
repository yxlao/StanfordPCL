...
struct EIGEN_ALIGN16 ParticleXYZRPY : public _ParticleXYZRPY {
    ...
    inline ParticleXYZRPY(float _x, float _y, float _z, float _roll,
    ...
    inline static int stateDimension() { return 6; }

    void sample(const std::vector<double> &mean,
    ...
    static pcl::tracking::ParticleXYZRPY toState(const Eigen::Affine3f &trans) {
        ...
        getTranslationAndEulerAngles(trans, trans_x, trans_y, trans_z,
                                     trans_roll, trans_pitch, trans_yaw);
        return pcl::tracking::ParticleXYZRPY(
            trans_x, trans_y, trans_z, trans_roll, trans_pitch, trans_yaw);
    }
...
inline std::ostream &operator<<(std::ostream &os, const ParticleXYZRPY &p) {
    os << "(" << p.x << "," << p.y << "," << p.z << "," << p.roll << ","
       << p.pitch << "," << p.yaw << ")";
    return (os);
}

// a * k
inline pcl::tracking::ParticleXYZRPY operator*(const ParticleXYZRPY &p,
                                               double val) {
...
// a + b
inline pcl::tracking::ParticleXYZRPY operator+(const ParticleXYZRPY &a,
...
struct EIGEN_ALIGN16 ParticleXYZR : public _ParticleXYZR {
    ...
    inline ParticleXYZR(float _x, float _y, float _z, float, float _pitch,
                        float) {
        x = _x;
        y = _y;
        z = _z;
    ...
    static pcl::tracking::ParticleXYZR toState(const Eigen::Affine3f &trans) {
        ...
        getTranslationAndEulerAngles(trans, trans_x, trans_y, trans_z,
                                     trans_roll, trans_pitch, trans_yaw);
        return (pcl::tracking::ParticleXYZR(trans_x, trans_y, trans_z, 0,
                                            trans_pitch, 0));
    }
...
// a * k
inline pcl::tracking::ParticleXYZR operator*(const ParticleXYZR &p,
                                             double val) {
...
// a + b
inline pcl::tracking::ParticleXYZR operator+(const ParticleXYZR &a,
...
// a * k
inline pcl::tracking::ParticleXYRPY operator*(const ParticleXYRPY &p,
                                              double val) {
...
// a + b
inline pcl::tracking::ParticleXYRPY operator+(const ParticleXYRPY &a,
...
struct EIGEN_ALIGN16 ParticleXYRP : public _ParticleXYRP {
    ...
    inline ParticleXYRP(float _x, float, float _z, float, float _pitch,
                        float _yaw) {
        x = _x;
        y = 0;
        z = _z;
...
// a * k
inline pcl::tracking::ParticleXYRP operator*(const ParticleXYRP &p,
                                             double val) {
...
// a + b
inline pcl::tracking::ParticleXYRP operator+(const ParticleXYRP &a,
...
struct EIGEN_ALIGN16 ParticleXYR : public _ParticleXYR {
    ...
    static pcl::tracking::ParticleXYR toState(const Eigen::Affine3f &trans) {
        ...
        getTranslationAndEulerAngles(trans, trans_x, trans_y, trans_z,
                                     trans_roll, trans_pitch, trans_yaw);
        return (
            pcl::tracking::ParticleXYR(trans_x, 0, trans_z, 0, trans_pitch, 0));
    }
...
// a + b
inline pcl::tracking::ParticleXYR operator+(const ParticleXYR &a,
                                            const ParticleXYR &b) {
    pcl::tracking::ParticleXYR newp;
    newp.x = a.x + b.x;
    newp.y = 0;
