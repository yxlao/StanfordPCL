...
#define MULT(x, z, p, ax, az, q, bx, bz, pb)                                   \
    R_MULT(x, z, p, ax, az, q, bx, bz, pb)
#define MULTADD(x, z, p, ax, az, q, bx, bz, pb)                                \
    R_MULTADD(x, z, p, ax, az, q, bx, bz, pb)
#define ADD(x, z, p, ax, az, q, bx, bz, pb)                                    \
    R_ADD(x, z, p, ax, az, q, bx, bz, pb)
#define ADD_REAL(x, p, ax, q, bx, r) R_ADD_REAL(x, p, ax, q, bx, r)
#define MULTSUB(x, z, p, ax, az, q, bx, bz, pb)                                \
    R_MULTSUB(x, z, p, ax, az, q, bx, bz, pb)
#define MULTADDCONJ(x, z, p, ax, az, q, bx, bz, pb)                            \
...
#define DIV_REAL(x, z, p, ax, az, q, bx, r)                                    \
    R_DIV_REAL(x, z, p, ax, az, q, bx, r)
#define MULT_REAL(x, z, p, ax, az, q, bx, r)                                   \
    R_MULT_REAL(x, z, p, ax, az, q, bx, r)
...
#define MULTADD(x, z, p, ax, az, q, bx, bz, pb)                                \
    C_MULTADD(x, z, p, ax, az, q, bx, bz, pb)
#define MULT(x, z, p, ax, az, q, bx, bz, pb)                                   \
    C_MULT(x, z, p, ax, az, q, bx, bz, pb)
#define ADD(x, z, p, ax, az, q, bx, bz, pb)                                    \
    C_ADD(x, z, p, ax, az, q, bx, bz, pb)
#define ADD_REAL(x, p, ax, q, bx, r) C_ADD_REAL(x, p, ax, q, bx, r)
#define MULTSUB(x, z, p, ax, az, q, bx, bz, pb)                                \
    C_MULTSUB(x, z, p, ax, az, q, bx, bz, pb)
#define MULTADDCONJ(x, z, p, ax, az, q, bx, bz, pb)                            \
...
#define DIV_REAL(x, z, p, ax, az, q, bx, r)                                    \
    C_DIV_REAL(x, z, p, ax, az, q, bx, r)
#define MULT_REAL(x, z, p, ax, az, q, bx, r)                                   \
    C_MULT_REAL(x, z, p, ax, az, q, bx, r)
...
#define MULTADD(x, z, p, ax, az, q, bx, bz, pb)                                \
    Z_MULTADD(x, z, p, ax, az, q, bx, bz, pb)
#define MULT(x, z, p, ax, az, q, bx, bz, pb)                                   \
    Z_MULT(x, z, p, ax, az, q, bx, bz, pb)
#define ADD(x, z, p, ax, az, q, bx, bz, pb)                                    \
    Z_ADD(x, z, p, ax, az, q, bx, bz, pb)
#define ADD_REAL(x, p, ax, q, bx, r) Z_ADD_REAL(x, p, ax, q, bx, r)
#define MULTSUB(x, z, p, ax, az, q, bx, bz, pb)                                \
    Z_MULTSUB(x, z, p, ax, az, q, bx, bz, pb)
#define MULTADDCONJ(x, z, p, ax, az, q, bx, bz, pb)                            \
...
#define DIV_REAL(x, z, p, ax, az, q, bx, r)                                    \
    Z_DIV_REAL(x, z, p, ax, az, q, bx, r)
#define MULT_REAL(x, z, p, ax, az, q, bx, r)                                   \
    Z_MULT_REAL(x, z, p, ax, az, q, bx, r)
