...
#define BLAS_zgemv(trans, m, n, alpha, A, lda, X, incx, beta, Y, incy)         \
    {                                                                          \
        ...
        if (!CHECK_BLAS_INT || BLAS_OK) {                                      \
            BLAS_ZGEMV(trans, &M, &N, alpha, A, &LDA, X, &INCX, beta, Y,       \
                       &INCY);                                                 \
        }                                                                      \
    }
...
#define BLAS_dtrsm(side, uplo, transa, diag, m, n, alpha, A, lda, B, ldb)      \
    {                                                                          \
        ...
        if (CHECK_BLAS_INT &&                                                  \
            !(EQ(M, m) && EQ(N, n) && EQ(LDA, lda) && EQ(LDB, ldb))) {         \
            BLAS_OK = FALSE;                                                   \
        }                                                                      \
        if (!CHECK_BLAS_INT || BLAS_OK) {                                      \
...
#define BLAS_ztrsm(side, uplo, transa, diag, m, n, alpha, A, lda, B, ldb)      \
    {                                                                          \
        ...
        if (!CHECK_BLAS_INT || BLAS_OK) {                                      \
            BLAS_ZTRSM(side, uplo, transa, diag, &M, &N, alpha, A, &LDA, B,    \
                       &LDB);                                                  \
        }                                                                      \
    }
...
#define BLAS_dgemm(transa, transb, m, n, k, alpha, A, lda, B, ldb, beta, C,    \
    ...
    {                                                                          \
        ...
        if (CHECK_BLAS_INT &&                                                  \
            !(EQ(M, m) && EQ(N, n) && EQ(K, k) && EQ(LDA, lda) &&              \
...
#define BLAS_zgemm(transa, transb, m, n, k, alpha, A, lda, B, ldb, beta, C,    \
    ...
    {                                                                          \
        ...
        if (!CHECK_BLAS_INT || BLAS_OK) {                                      \
            BLAS_ZGEMM(transa, transb, &M, &N, &K, alpha, A, &LDA, B, &LDB,    \
                       beta, C, &LDC);                                         \
        }                                                                      \
    }
...
#define BLAS_dsyrk(uplo, trans, n, k, alpha, A, lda, beta, C, ldc)             \
    {                                                                          \
        ...
        if (CHECK_BLAS_INT &&                                                  \
            !(EQ(N, n) && EQ(K, k) && EQ(LDA, lda) && EQ(LDC, ldc))) {         \
            BLAS_OK = FALSE;                                                   \
        }                                                                      \
        if (!CHECK_BLAS_INT || BLAS_OK) {                                      \
