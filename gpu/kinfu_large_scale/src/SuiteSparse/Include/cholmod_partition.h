...
SuiteSparse_long
cholmod_l_nested_dissection(cholmod_sparse *, SuiteSparse_long *, size_t,
...
int cholmod_l_csymamd(cholmod_sparse *, SuiteSparse_long *, SuiteSparse_long *,
                      cholmod_common *);
...
SuiteSparse_long cholmod_l_bisect(cholmod_sparse *, SuiteSparse_long *, size_t,
                                  int, SuiteSparse_long *, cholmod_common *);
...
SuiteSparse_long cholmod_l_metis_bisector(cholmod_sparse *, SuiteSparse_long *,
                                          SuiteSparse_long *,
                                          SuiteSparse_long *, cholmod_common *);
