 ...
 */
template <typename MatrixType> class MatrixExponential {
...
MatrixExponential<MatrixType>::MatrixExponential(const MatrixType &M)
    : m_M(M), m_U(M.rows(), M.cols()), m_V(M.rows(), M.cols()),
      m_tmp1(M.rows(), M.cols()), m_tmp2(M.rows(), M.cols()),
      m_Id(MatrixType::Identity(M.rows(), M.cols())), m_squarings(0),
...
MatrixExponential<MatrixType>::pade3(const MatrixType &A) {
...
template <typename MatrixType>
EIGEN_STRONG_INLINE void
MatrixExponential<MatrixType>::pade5(const MatrixType &A) {
...
template <typename MatrixType>
EIGEN_STRONG_INLINE void
MatrixExponential<MatrixType>::pade7(const MatrixType &A) {
...
template <typename MatrixType>
EIGEN_STRONG_INLINE void
MatrixExponential<MatrixType>::pade9(const MatrixType &A) {
...
template <typename MatrixType>
EIGEN_STRONG_INLINE void
MatrixExponential<MatrixType>::pade13(const MatrixType &A) {
...
template <typename MatrixType>
EIGEN_STRONG_INLINE void
MatrixExponential<MatrixType>::pade17(const MatrixType &A) {
...
struct MatrixExponentialReturnValue
  ...
  private:
    ...
    operator=(const MatrixExponentialReturnValue &);
};
