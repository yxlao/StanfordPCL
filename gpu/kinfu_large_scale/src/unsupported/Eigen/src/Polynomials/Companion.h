...
template <typename _Scalar, int _Deg> class companion {
  ...
  protected:
     ...
     * */
    bool balanced(Scalar colNorm, Scalar rowNorm, bool &isBalanced,
                  Scalar &colB, Scalar &rowB);
     ...
     * the column and the row in order to balance them.
     * */
    bool balancedR(Scalar colNorm, Scalar rowNorm, bool &isBalanced,
                   Scalar &colB, Scalar &rowB);
