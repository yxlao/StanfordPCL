...
template <typename _Scalar> struct kiss_cpx_fft {
    ...
    void factorize(int nfft) {
        ...
        do {
            ...
            if (p > 5)
                m_scratchBuf.resize(
                    p); // scratchbuf will be needed in bfly_generic
        } while (n > 1);
    }
    ...
    inline void bfly5(Complex *Fout, const size_t fstride, const size_t m) {
        ...
        for (u = 0; u < m; ++u) {
            ...
            *Fout0 += scratch[8];
            ...
            scratch[5] =
                scratch[0] + Complex((scratch[7].real() * ya.real()) +
                                         (scratch[8].real() * yb.real()),
                                     (scratch[7].imag() * ya.real()) +
                                         (scratch[8].imag() * yb.real()));

            scratch[6] = Complex((scratch[10].imag() * ya.imag()) +
                                     (scratch[9].imag() * yb.imag()),
                                 -(scratch[10].real() * ya.imag()) -
            ...
            *Fout4 = scratch[5] + scratch[6];
            ...
            scratch[11] =
                scratch[0] + Complex((scratch[7].real() * yb.real()) +
                                         (scratch[8].real() * ya.real()),
                                     (scratch[7].imag() * yb.real()) +
                                         (scratch[8].imag() * ya.real()));

            scratch[12] = Complex(-(scratch[10].imag() * yb.imag()) +
                                      (scratch[9].imag() * ya.imag()),
                                  (scratch[10].real() * yb.imag()) -
    ...
    inline void bfly_generic(Complex *Fout, const size_t fstride, int m,
                             int p) {
        int u, k, q1, q;
        Complex *twiddles = &m_twiddles[0];
        Complex t;
...
template <typename _Scalar> struct kissfft_impl {
    ...
    inline void fwd(Complex *dst, const Scalar *src, int nfft) {
        if (nfft & 3) {
            ...
            std::copy(m_tmpBuf1.begin(), m_tmpBuf1.begin() + (nfft >> 1) + 1,
                      dst);
        } else {
            int ncfft = nfft >> 1;
            int ncfft2 = nfft >> 2;
