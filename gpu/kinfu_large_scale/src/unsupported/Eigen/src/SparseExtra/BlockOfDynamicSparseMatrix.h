...
class SparseInnerVectorSet<DynamicSparseMatrix<_Scalar, _Options, _Index>, Size>
    : public SparseMatrixBase<SparseInnerVectorSet<
  ...
  public:
    ...
    operator=(const SparseMatrixBase<OtherDerived> &other) {
        if (IsRowMajor !=
            ...
            // need to transpose => perform a block evaluation followed by a big
            // swap
            DynamicSparseMatrix<Scalar, IsRowMajor ? RowMajorBit : 0> aux(
                other);
