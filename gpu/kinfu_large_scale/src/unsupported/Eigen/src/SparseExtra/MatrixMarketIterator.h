...
template <typename Scalar> class MatrixMarketIterator {
  ...
  public:
    ...
    inline MatrixType &matrix() {
        ...
        if (m_sym != NonSymmetric) { // Store the upper part of the matrix. It
                                     // is needed by the solvers dealing with
    ...
    inline VectorType &rhs() {
        ...
        std::string rhs_file;
        rhs_file = m_folder + "/" + m_matname +
                   "_b.mtx"; // The pattern is matname_b.mtx
