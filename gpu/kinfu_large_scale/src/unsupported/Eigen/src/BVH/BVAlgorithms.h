    ...
    while (!todo.empty()) {
        ...
        for (; vBegin1 != vEnd1;
            ...
            for (vCur2 = vBegin2; vCur2 != vEnd2;
                ...
                if (intersector.intersectVolumeVolume(vol1,
                                                      tree2.getVolume(*vCur2)))
...
typename Minimizer::Scalar BVMinimize(const BVH1 &tree1, const BVH2 &tree2,
    ...
    while (!todo.empty()) {
        tree1.getChildren(todo.top().second.first, vBegin1, vEnd1, oBegin1,
                          oEnd1);
        tree2.getChildren(todo.top().second.second, vBegin2, vEnd2, oBegin2,
                          oEnd2);
        todo.pop();
        ...
        for (; oBegin1 != oEnd1;
            ...
            for (oCur2 = oBegin2; oCur2 != oEnd2;
                 ++oCur2) { // go through child objects of second tree
                minimum = (std::min)(
                    minimum, minimizer.minimumOnObjectObject(*oBegin1, *oCur2));
            }
            ...
            for (vCur2 = vBegin2; vCur2 != vEnd2;
                ...
                minimum = (std::min)(
                    minimum,
                    internal::minimize_helper(tree2, helper, *vCur2, minimum));
            }
        }
        ...
        for (; vBegin1 != vEnd1;
            ...
            for (oCur2 = oBegin2; oCur2 != oEnd2;
                ...
                minimum =
                    (std::min)(minimum, internal::minimize_helper(
                                            tree1, helper, *vBegin1, minimum));
            }

            for (vCur2 = vBegin2; vCur2 != vEnd2;
                 ++vCur2) { // go through child volumes of second tree
                Scalar val = minimizer.minimumOnVolumeVolume(
                    vol1, tree2.getVolume(*vCur2));
                if (val < minimum)
                    todo.push(
                        std::make_pair(val, std::make_pair(*vBegin1, *vCur2)));
            }
        }
    }
    return minimum;
