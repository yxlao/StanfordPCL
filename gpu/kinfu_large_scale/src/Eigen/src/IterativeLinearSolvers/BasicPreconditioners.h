...
template <typename _Scalar> class DiagonalPreconditioner {
  ...
  public:
    // this typedef is only to export the scalar type and compile-time
    // dimensions to solve_retval
...
class IdentityPreconditioner {
  public:
    ...
    template <typename MatrixType> IdentityPreconditioner(const MatrixType &) {}
