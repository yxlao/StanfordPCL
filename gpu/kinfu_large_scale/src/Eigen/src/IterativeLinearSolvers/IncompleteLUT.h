 ...
 */
template <typename _Scalar> class IncompleteLUT : internal::noncopyable {
  ...
  public:
    ...
    IncompleteLUT(const MatrixType &mat,
        ...
        : m_droptol(droptol), m_fillfactor(fillfactor), m_analysisIsOk(false),
          m_factorizationIsOk(false), m_isInitialized(false) {
    ...
    solve(const MatrixBase<Rhs> &b) const {
        ...
        eigen_assert(cols() == b.rows() &&
                     "IncompleteLUT::solve(): invalid number of rows of the "
...
void IncompleteLUT<Scalar>::factorize(const _MatrixType &amat) {
    ...
    for (int ii = 0; ii < n; ii++) {
        ...
        int sizeu = 1; // number of nonzero elements in the upper part of the
                       // current row
        int sizel = 0; // number of nonzero elements in the lower part of the
                       // current row
        ju(ii) = ii;
        u(ii) = 0;
        jr(ii) = ii;
        ...
        while (jj < sizel) {
            ...
            int k;
            int minrow = ju.segment(jj, sizel - jj)
