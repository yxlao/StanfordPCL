...
template <typename Scalar>
inline Quaternion<Scalar> &
Quaternion<Scalar>::operator*=(const Quaternion &other) {
...
template <typename Scalar>
inline Scalar
Quaternion<Scalar>::angularDistance(const Quaternion &other) const {
...
template <typename Other> struct ei_quaternion_assign_impl<Other, 3, 3> {
...
template <typename Other> struct ei_quaternion_assign_impl<Other, 4, 1> {
    typedef typename Other::Scalar Scalar;
