...
class QuaternionBase : public RotationBase<Derived, 3> {
  ...
  public:
    ...
    template <class OtherDerived>
    EIGEN_STRONG_INLINE Quaternion<Scalar>
     ...
     * *this \a t in [0;1] see http://en.wikipedia.org/wiki/Slerp
     */
    template <class OtherDerived>
    ...
    template <class OtherDerived>
    bool
    isApprox(const QuaternionBase<OtherDerived> &other,
...
QuaternionBase<Derived>::slerp(
    Scalar t, const QuaternionBase<OtherDerived> &other) const {
    using std::acos;
