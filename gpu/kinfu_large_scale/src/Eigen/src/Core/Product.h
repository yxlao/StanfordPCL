...
namespace internal {
template <typename Lhs, typename Rhs> struct traits<Product<Lhs, Rhs>> {
    ...
    typedef typename promote_storage_type<
        typename traits<LhsCleaned>::StorageKind,
        typename traits<RhsCleaned>::StorageKind>::ret StorageKind;
    typedef
        typename promote_index_type<typename traits<LhsCleaned>::Index,
                                    typename traits<RhsCleaned>::Index>::type
            Index;
    enum {
        ...
        Flags =
            (MaxRowsAtCompileTime == 1 ? RowMajorBit
                                       : 0), // TODO should be no storage order
        CoeffReadCost =
            0 // TODO CoeffReadCost should not be part of the expression traits
    };
};
...
template <typename Lhs, typename Rhs>
class ProductImpl<Lhs, Rhs, Dense>
