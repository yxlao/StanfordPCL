...
template <typename Scalar> struct real_impl {
    typedef typename NumTraits<Scalar>::Real RealScalar;
    static inline RealScalar run(const Scalar &x) { return x; }
};

template <typename RealScalar> struct real_impl<std::complex<RealScalar>> {
...
template <typename Scalar> struct imag_impl {
    typedef typename NumTraits<Scalar>::Real RealScalar;
    static inline RealScalar run(const Scalar &) { return RealScalar(0); }
};

template <typename RealScalar> struct imag_impl<std::complex<RealScalar>> {
    static inline RealScalar run(const std::complex<RealScalar> &x) {
        using std::imag;
        return imag(x);
    }
...
template <typename Scalar> struct conj_impl {
    static inline Scalar run(const Scalar &x) { return x; }
};

template <typename RealScalar> struct conj_impl<std::complex<RealScalar>> {
    static inline std::complex<RealScalar>
...
template <typename Scalar> struct conj_retval { typedef Scalar type; };
...
template <typename Scalar> struct abs_impl {
    typedef typename NumTraits<Scalar>::Real RealScalar;
...
template <typename Scalar> struct abs_retval {
    typedef typename NumTraits<Scalar>::Real type;
};
...
template <typename RealScalar> struct abs2_impl<std::complex<RealScalar>> {
    static inline RealScalar run(const std::complex<RealScalar> &x) {
...
template <typename Scalar, bool IsInteger> struct sqrt_default_impl {
...
template <typename Scalar> struct sqrt_default_impl<Scalar, true> {
...
template <typename Scalar> struct sqrt_retval { typedef Scalar type; };
...
template <typename Scalar, bool IsInteger> struct atan2_default_impl {
...
template <typename Scalar> struct atan2_default_impl<Scalar, true> {
...
template <typename Scalar> struct atan2_retval { typedef Scalar type; };
...
template <typename Scalar, bool IsInteger> struct pow_default_impl {
    typedef Scalar retval;
    static inline Scalar run(const Scalar &x, const Scalar &y) {
        using std::pow;
        return pow(x, y);
...
template <typename Scalar> struct pow_default_impl<Scalar, true> {
...
template <typename Scalar> struct pow_retval { typedef Scalar type; };
...
template <typename Scalar> struct random_retval { typedef Scalar type; };
