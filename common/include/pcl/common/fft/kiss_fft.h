...
kiss_fft_cfg PCL_EXPORTS kiss_fft_alloc(int nfft, int inverse_fft, void *mem,
                                        size_t *lenmem);
 ...
 * Note that each element is complex and can be accessed like
    f[k].r and f[k].i
 * */
void PCL_EXPORTS kiss_fft(kiss_fft_cfg cfg, const kiss_fft_cpx *fin,
                          kiss_fft_cpx *fout);
...
/*
 ...
 sample.
 * */
void PCL_EXPORTS kiss_fft_stride(kiss_fft_cfg cfg, const kiss_fft_cpx *fin,
