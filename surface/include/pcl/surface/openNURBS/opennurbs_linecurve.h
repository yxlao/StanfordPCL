...
class ON_CLASS ON_LineCurve : public ON_Curve {
  ...
  public:
    ON_LineCurve();
    ON_LineCurve(const ON_2dPoint &,
                 const ON_2dPoint &); // creates a 2d line curve
    ON_LineCurve(const ON_3dPoint &,
                 const ON_3dPoint &); // creates a 3d line curve
    ...
    */
    ...
    //       desired accuracy.
    int GetNurbForm(ON_NurbsCurve &, double = 0.0,
