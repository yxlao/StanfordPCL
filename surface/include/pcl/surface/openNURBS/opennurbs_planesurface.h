...
class ON_CLASS ON_PlaneSurface : public ON_Surface {
  ...
  public:
    ...
    */
    bool GetClosestPoint(const ON_3dPoint &P, double *s, double *t,
    ...
    */
    ...
    Returns:
      true if successful
    */
    bool CreatePseudoInfinitePlane(ON_PlaneEquation plane_equation,
    ...
    Returns:
      true if successful
    */
    bool CreatePseudoInfinitePlane(const ON_Plane &plane,
                                   const ON_BoundingBox &bbox,
                                   double padding = 0.0625);
    ...
    Returns:
      true if successful
    */
    bool CreatePseudoInfinitePlane(const ON_Plane &plane, int point_count,
