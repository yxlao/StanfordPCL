...
class ON_CLASS ON_TensorProduct {
  ...
  public:
    ...
    virtual int DimensionA() const = 0; // dimension of A space

    virtual int DimensionB() const = 0; // dimension of B space

    virtual int DimensionC() const = 0; // dimension of range space

    virtual bool Evaluate(double,         // a
                          const double *, // A
                          double,         // b
                          const double *, // B
                          double *        // C
...
class ON_CLASS ON_NurbsSurface : public ON_Surface {
  ...
  public:
    ...
    */
    ...
    static ON_NurbsSurface *New(int dimension, ON_BOOL32 bIsRational,
    ...
    */
    bool IsDuplicate(const ON_NurbsSurface &other, bool bIgnoreParameterization,
                     double tolerance = ON_ZERO_TOLERANCE) const;

    void Initialize(void); // zeros all fields

    ON_BOOL32 Create(int dim,          // dimension (>= 1)
    ...
    */
    virtual int CreateRuledSurface(const ON_Curve &curveA,
    ...
    */
    int CreateConeSurface(ON_3dPoint apex_point, const ON_Curve &curve,
    ...
    */
    ...
    ON_BOOL32 Write(ON_BinaryArchive & // open binary file
    ) const;

    ON_BOOL32 Read(ON_BinaryArchive & // open binary file
    );
    ...
    */
    ...
    double SuperfluousKnot(int dir, // dir 0 = "s", 1 = "t"
                           int end  // 0 = start, 1 = end
    ) const;

    double GrevilleAbcissa(int dir,     // dir
    ...
    bool SetPeriodicGrevilleKnotVector(int dir,        // dir
                                       int g_stride,   // g_stride
    ...
    bool IncreaseDegree(int dir,           // dir 0 = "s", 1 = "t"
                        int desired_degree //  desired_degree
    );

    bool ChangeDimension(int desired_dimension //  desired_dimension
    );
    ...
    Parameters:
      ...
      t -		[in] dir parameter of seam, must have
    Domain(dir).Includes(t). The resulting surface domain in the dir direction
    will start at t. Returns: true if successful.
    */
    ON_BOOL32 ChangeSurfaceSeam(int dir, double t);

    // Creates a tensor product nurbs surface with srf(s,t) = T(A(s),B(t));
    ON_BOOL32 TensorProduct(const ON_NurbsCurve &, // A
    ...
    Parameters:
      span_index0 - [in] Specifies the "u" span and must satisfy
           ...
           m_knot[0][span_index0+m_order[0]-2] <
    m_knot[0][span_index0+m_order[0]-1] span_index1 - [in] Specifies the "v"
    span and must satisfy 0 <= span_index1 <= m_cv_count[1]-m_order[1]
           m_knot[1][span_index1+m_order[1]-2] <
    m_knot[1][span_index1+m_order[1]-1] bezier_surface - [out] bezier surface
    returned here Returns: true if successful false if input is not valid
    */
    ON_BOOL32 ConvertSpanToBezier(int span_index0, int span_index1,
                                  ON_BezierSurface &bezier_surface) const;

    /////////////////////////////////////////////////////////////////
    // Implementation
  public:
    // NOTE: These members are left "public" so that expert users may
    // efficiently
...
class ON_CLASS ON_NurbsCage : public ON_Geometry {
  ...
  public:
    ...
    ON_NurbsCage(int dim, bool is_rat, int order0, int order1, int order2,
    ...
    */
    bool Create(const ON_3dPoint *box_corners, int order0, int order1,
    ...
    ON_Interval Domain(int // dir 0 = "r", 1 = "s", 2 = "t"
    ) const;

    bool Reverse(int dir // dir 0 = "r", 1 = "s", 2 = "t"
    );
    ...
    ON_BOOL32 IncreaseDegree(int dir,           // dir 0 = "r", 1 = "s", 2 = "t"
                             int desired_degree //  desired_degree
    );

    ON_BOOL32 ChangeDimension(int desired_dimension //  desired_dimension
    );
    ...
    Parameters:
      ...
      der_count - [in]  (>= 0)
      v_stride - [in] (>= m_dim)
      v - [out] An array of length
    v_stride*(der_count+1)(der_count+2)*(der_count+3)/6. The evaluation results
    are stored in this array.
                ...
                In general, Dr^i Ds^j Dt^k is returned in v[n],...,v[n+m_dim-1],
    where
    ...
    */
    bool Evaluate(double r, double s, double t, int der_count, int v_stride,
                  double *v, int side = 0, int *hint = 0) const;
    ...
    */
    ...
    ON_NurbsSurface *IsoSurface(int dir, double c,
    ...
    */
    ...
    int Order(int dir // dir 0 = "r", 1 = "s", 2 = "t"
    ) const;
    ...
    int SpanCount(int dir // dir 0 = "r", 1 = "s", 2 = "t"
    ) const;

    bool GetSpanVector(int dir, // dir 0 = "r", 1 = "s", 2 = "t"
...
class ON_CLASS ON_MorphControl : public ON_Geometry {
  ...
  public:
    ...
    */
    ...
    bool AddCylinderLocalizer(ON_Line axis, double support_distance,
                              double falloff_distance);

    bool AddBoxLocalizer(ON_BoundingBox bbox, double support_distance,
                         double falloff_distance);

    bool AddPlaneLocalizer(const ON_Plane &plane, double support_distance,
                           double falloff_distance);

    bool AddConvexPolygonLocalizer(const ON_SimpleArray<ON_Plane> &planes,
    ...
    */
    void MorphPointLocalizerHelper(const ON_3dPoint &point, double &w,
                                   double &clspt_max_dist,
                                   const ON_Localizer *&distloc) const;

    void MorphPointVarient1Helper(double t, double w,
                                  const ON_Localizer *distloc, ON_3dPoint &Q,
                                  ON_3dVector *N) const;

    void MorphPointVarient2Helper(double s, double t, double w,
                                  const ON_Localizer *distloc, ON_3dPoint &Q,
                                  ON_3dVector *N) const;
