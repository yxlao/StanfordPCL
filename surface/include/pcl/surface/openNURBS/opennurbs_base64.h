...
class ON_CLASS ON_Base64EncodeStream {
  public:
    ...
    */
    bool SetCallback(ON_StreamCallbackFunction callback_function,
    ...
    */
    virtual bool Out(void *callback_context, ON__UINT32 out_buffer_size,
...
private:
  ...
  unsigned int  m_unused2; // Here for alignment purposes. Never used by
opennurbs. unsigned int  m_input_count; unsigned char m_input[64];
