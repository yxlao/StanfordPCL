...
class ON_CLASS ON_CurveProxyHistory {
  public:
    ...
    ON_Interval
        m_full_real_curve_domain; // from ON_CurveProxy.m_real_curve.Domain()
    ON_Interval
        m_sub_real_curve_domain;      // from ON_CurveProxy.m_real_curve_domain
...
class ON_CLASS ON_HistoryRecord : public ON_Object {
  ...
  public:
    ...
    */
    ...
    bool SetPointOnObjectValue(int value_id, const ON_ObjRef &oref,
                               ON_3dPoint point);
    ...
    */
    ...
    bool SetPolyEdgeValues(int value_id, int count,
    ...
    */
    ...
    bool GetPolyEdgeValue(int value_id,
    ...
    int GetGeometryValues(int value_id,
                          ON_SimpleArray<const ON_Geometry *> &) const;
    int GetUuidValues(int value_id, ON_SimpleArray<ON_UUID> &) const;
    int GetPolyEdgeValues(int value_id,
                          ON_SimpleArray<const ON_PolyEdgeHistory *> &) const;
