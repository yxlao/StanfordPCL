...
class ON_CLASS ON_MassProperties {
  public:
    ...
    */
    ON_Matrix *WorldCoordIntertiaMatrix(ON_Matrix *matrix = NULL) const;
    ...
    */
    bool WorldCoordPrincipalMoments(double *pxx, ON_3dVector &Ax, double *pyy,
                                    ON_3dVector &Ay, double *pzz,
    ...
    */
    ON_Matrix *CentroidCoordIntertiaMatrix(ON_Matrix *matrix = NULL) const;
    ...
    */
    bool CentroidCoordPrincipalMoments(double *pxx, ON_3dVector &Ax,
                                       double *pyy, ON_3dVector &Ay,
                                       double *pzz, ON_3dVector &Az) const;
};
