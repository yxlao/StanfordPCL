...
class ON_CLASS ON_TextLog {
  public:
    ...
    */
    ...
    void PrintWrappedText(const char *,
                          int = 60); // last arg is maximum line length
    void PrintWrappedText(const wchar_t *,
                          int = 60); // last arg is maximum line length
    ...
    */
    ...
    void PrintKnotVector(int,           // order
                         int,           // cv_count
