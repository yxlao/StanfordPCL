...
class ON_CLASS ON_Color {
  public:
    ...
    */
    ...
    void SetRGB(int red,   // red in range 0 to 255
                int green, // green in range 0 to 255
                int blue   // blue in range 0 to 255
    );

    void SetFractionalRGB(double red,   // red in range 0.0 to 1.0
    ...
    void SetFractionalAlpha(double alpha // alpha in range 0.0 to 1.0 (0.0 =
    ...
    // input args
    void SetFractionalRGBA(double red,   // red in range 0.0 to 1.0
                           double green, // green in range 0.0 to 1.0
                           double blue,  // blue in range 0.0 to 1.0
                           double alpha  // alpha in range 0.0 to 1.0 (0.0 =
                                         // opaque, 1.0 = transparent)
    );
    ...
    void SetHSV(double h, // hue in radians 0 to 2*pi
