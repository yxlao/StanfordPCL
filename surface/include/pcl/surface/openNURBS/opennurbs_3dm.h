...
/*  Typecode format 4 bytes long
  ...
  | |               | |               | |  |
   ...
   |        |        |         +-- specific codes
   |        |        |
   |        |        +-- RESERVED - DO NOT USE (should be 0) (will be used to
  control CRC on/off) |        | |        +-- category:_000 0000 0000 0001
  Legacy geometry    TCODE_LEGACY_GEOMETRY |                     _000 0000 0000
  0010  openNURBS object   TCODE_OPENNURBS_OBJECT |                     _000
  0000 0000 0100  -- RESERVED - DO NOT USE (should be 0 in any typecode) -- |
  _000 0000 0000 1000  -- RESERVED - DO NOT USE (should be 0 in any typecode) --
   ...
   |                     _000 0100 0000 0000  -- RESERVED - DO NOT USE (should
  be 0 in any typecode) -- |                     _000 1000 0000 0000  Tolerances
  TCODE_TOLERANCE |                     _001 0000 0000 0000  Tables TCODE_TABLE
...
#define TCODE_HATCHPATTERN_TABLE                                               \
    (TCODE_TABLE | 0x0022) /* hatch pattern table */
...
#define TCODE_TEXTURE_MAPPING_TABLE                                            \
    (TCODE_TABLE | 0x0025) /* texture mappings */
...
#define TCODE_PROPERTIES_COMPRESSED_PREVIEWIMAGE                               \
    (TCODE_TABLEREC | TCODE_CRC | 0x0025)
#define TCODE_PROPERTIES_OPENNURBS_VERSION                                     \
    (TCODE_TABLEREC | TCODE_SHORT | 0x0026)
...
#define TCODE_SETTINGS_CURRENT_LAYER_INDEX                                     \
    (TCODE_TABLEREC | TCODE_SHORT | 0x0038)
#define TCODE_SETTINGS_CURRENT_MATERIAL_INDEX                                  \
    (TCODE_TABLEREC | TCODE_CRC | 0x0039)
...
#define TCODE_SETTINGS_CURRENT_WIRE_DENSITY                                    \
    (TCODE_TABLEREC | TCODE_SHORT | 0x003C)
...
#define TCODE_SETTINGS_CURRENT_FONT_INDEX                                      \
    (TCODE_TABLEREC | TCODE_SHORT | 0x0132)
#define TCODE_SETTINGS_CURRENT_DIMSTYLE_INDEX                                  \
    (TCODE_TABLEREC | TCODE_SHORT | 0x0133)
/* added 29 October 2002 as a chunk to hold new and future ON_3dmSettings
 * information */
...
/* added 29 October 2002 as a chunk to hold new and future ON_3dmView
 * information */
#define TCODE_VIEW_ATTRIBUTES (TCODE_TABLEREC | TCODE_CRC | 0x0C3B)

/* added 27 June 2008 as a chunk to hold userdata on ON_Viewports saved in named
 * view list */
...
#define TCODE_BITMAP_RECORD                                                    \
    (TCODE_TABLEREC | TCODE_CRC |                                              \
     0x0090) /* bitmap table record derived from ON_Bitmap */
...
#define TCODE_LAYER_RECORD                                                     \
    (TCODE_TABLEREC | TCODE_CRC |                                              \
     0x0050) /* layer table record derived from ON_Layer */

/* records in light table */
#define TCODE_LIGHT_RECORD                                                     \
    (TCODE_TABLEREC | TCODE_CRC |                                              \
     0x0060) /* light table record derived from ON_Light */
...
/* records in user table
     Each user table entery has two top level chunks, a TCODE_USER_TABLE_UUID
   chunk and a TCODE_USER_RECORD chunk.
*/
...
/* the user record header was added in 200910190 and is inside the
 * TCODE_USER_TABLE_UUID chunk */
...
//
//   TCODE_OBJECT_RECORD_TYPE required - used to quickly filter and skip
unwanted objects
...
//         4 byte length
//         16 byte value of ON_ClassId::m_uuid for this child class of
ON_UserData
...
#define TCODE_OPENNURBS_CLASS_END                                              \
    (TCODE_OPENNURBS_OBJECT | TCODE_SHORT | 0x7FFF)
...
//   16 byte UUID ( a.k.a. GUID ) openNURBS class ID - determines specific
openNURBS class
...
//
//
//  The TCODEs below were used in the version 1 file format and are needed so
that
//  the these files can be read and (optionally) written by the current
OpenNURBS
//  toolkit.
//
//
...
#define TCODE_OPENNURBS_BUFFER                                                 \
    (TCODE_OPENNURBS_OBJECT | TCODE_CRC |                                      \
     0x0100) /* chunk stores ON_Buffer classes */
...
#define TCODE_LEGACY_ASMSTUFF                                                  \
    (TCODE_LEGACY_GEOMETRY | TCODE_STUFF | TCODE_LEGACY_ASM)
#define TCODE_LEGACY_PRTSTUFF                                                  \
    (TCODE_LEGACY_GEOMETRY | TCODE_STUFF | TCODE_LEGACY_PRT)
#define TCODE_LEGACY_SHLSTUFF                                                  \
    (TCODE_LEGACY_GEOMETRY | TCODE_STUFF | TCODE_LEGACY_SHL)
#define TCODE_LEGACY_FACSTUFF                                                  \
    (TCODE_LEGACY_GEOMETRY | TCODE_STUFF | TCODE_LEGACY_FAC)
#define TCODE_LEGACY_BNDSTUFF                                                  \
    (TCODE_LEGACY_GEOMETRY | TCODE_STUFF | TCODE_LEGACY_BND)
#define TCODE_LEGACY_TRMSTUFF                                                  \
    (TCODE_LEGACY_GEOMETRY | TCODE_STUFF | TCODE_LEGACY_TRM)
#define TCODE_LEGACY_SRFSTUFF                                                  \
    (TCODE_LEGACY_GEOMETRY | TCODE_STUFF | TCODE_LEGACY_SRF)
#define TCODE_LEGACY_CRVSTUFF                                                  \
    (TCODE_LEGACY_GEOMETRY | TCODE_STUFF | TCODE_LEGACY_CRV)
#define TCODE_LEGACY_SPLSTUFF                                                  \
    (TCODE_LEGACY_GEOMETRY | TCODE_STUFF | TCODE_LEGACY_SPL)
#define TCODE_LEGACY_PNTSTUFF                                                  \
    (TCODE_LEGACY_GEOMETRY | TCODE_STUFF | TCODE_LEGACY_PNT)
...
#define TCODE_RGBDISPLAY                                                       \
    (TCODE_SHORT | TCODE_DISPLAY |                                             \
     0x0006) /* will be used for color by object */
#define TCODE_RENDER_MATERIAL_ID                                               \
    (TCODE_DISPLAY | 0x0007) /* id for render material */
...
/* use LAYERSTATE ( 0 = LAYER_ON, 1 = LAYER_OFF, 2 = LAYER_LOCKED ) instead of
 * above individual toggles */
