...
class ON_CLASS ON_InstanceDefinition : public ON_Geometry {
  ...
  public:
    ...
    Parameters:
      ...
      source_type - [in] See comments for
    ON_InstanceDefinition::IDEF_UPDATE_TYPE Remarks: In all cases, the complete
    instance definition geometry is stored in the 3dm archive.  When an instance
    definition is linked or embedded, applications can examine the source
      archive settings and update the  definition when appropriate.
      The checksum can be used to detect changed files.
    */
    void SetSourceArchive(const wchar_t *source_archive, ON_CheckSum checksum,
    ...
    */
    void UpdateLinkedIdefReferenceFileLayerSettings(unsigned int layer_count,
    ...
    */
    void UpdateLinkedIdefParentLayerSettings(
    ...
    */
    void UpdateLinkedIdefLayerSettings(unsigned int layer_count,
  ...
  public:
    ...
    int m_idef_update_depth; // Controls how much geometry is read when
                             ...
                             //   0: read everything, included nested linked
                             //   idefs 1: skip nested linked idefs.
