  ...
  public:
    ...
    */
    ...
    Returns:
      true if valid plane is created.
    */
    bool CreateFromFrame(const ON_3dPoint &origin, const ON_3dVector &x_dir,
                         const ON_3dVector &y_dir);
    ...
    Returns:
      true if valid plane is created.
    */
    bool CreateFromPoints(const ON_3dPoint &origin,
...
class ON_CLASS ON_ClippingPlane {
  public:
    ...
    ON_Plane m_plane;
    ON_UuidList
        m_viewport_ids; // ids of viewports that this clipping plane "clips"
    ON_UUID m_plane_id;
