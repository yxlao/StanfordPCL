...
class ON_CLASS ON_CurveProxy : public ON_Curve {
  ...
  private:
    ...
    // we have
    // t =
    // m_this_domain.ParameterAt(m_real_curve_domain.NormalizedParameterAt(r))
    // r =
    // m_real_curve_domain.ParameterAt(m_this_domain.NormalizedParameterAt(t))
    // and when m_bReversed==true we have
    // t = m_this_domain.ParameterAt(1 -
    // m_real_curve_domain.NormalizedParameterAt(r)) r =
    // m_real_curve_domain.ParameterAt(1 -
    // m_this_domain.NormalizedParameterAt(t))
  ...
  public:
    ...
    */
    ...
    ON_BOOL32 Split(double t, ON_Curve *&left_side,
    ...
    int GetNurbForm( // returns 0: unable to create NURBS representation
        ...
        const ON_Interval * =
            NULL // OPTIONAL subdomain of ON_CurveProxy::Domain()
    ) const;
