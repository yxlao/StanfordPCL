...
class ON_CLASS ON_BrepVertex : public ON_Point {
  ...
  public:
    ...
    */
    ...
    bool SetPoint(const ON_3dPoint & // point
    );
...
class ON_CLASS ON_BrepTrim : public ON_CurveProxy {
  ...
  public:
    ...
    // types of trim - access through m_type member.  Also see m_iso and
    // ON_Surface::ISO
    enum TYPE {
        unknown = 0,
...
class ON_CLASS ON_BrepLoop : public ON_Geometry {
  ...
  public:
    ...
    */
    ...
    enum TYPE {
        unknown = 0,
        outer = 1, // 2d loop curves form a simple closed curve with a
                   // counterclockwise orientation
        inner = 2, // 2d loop curves form a simple closed curve with a clockwise
                   // orientation
        slit = 3, // always closed - used internally during splitting operations
        crvonsrf =
            4, // "loop" is a curveonsrf made from a single
...
class ON_CLASS ON_Brep : public ON_Geometry {
  ...
  public:
    ...
    */
    bool IsDuplicate(const ON_Brep &other,
    ...
    */
    ...
    See Also:
      ...
      ON_BrepFace::SetMesh
    */
    int GetMesh(ON::mesh_type mesh_type,
    ...
    Returns:
      True if successful.
    */
    bool AreaMassProperties(ON_MassProperties &mp, bool bArea = true,
    ...
    Returns:
      True if successful.
    */
    bool VolumeMassProperties(ON_MassProperties &mp, bool bVolume = true,
                              bool bFirstMoments = true,
                              bool bSecondMoments = true,
                              bool bProductMoments = true,
    ...
    */
    ...
    // Returns:
    //   true if successful.
    bool SetEdgeCurve(ON_BrepEdge &edge, int c3_index,
    ...
    // Returns:
    //   true if successful.
    bool SetTrimCurve(ON_BrepTrim &trim, int c2_index,
                      const ON_Interval *sub_domain = NULL);
    ...
    ON_BrepVertex &NewVertex(ON_3dPoint vertex_point,
                             double vertex_tolerance = ON_UNSET_VALUE);

    ON_BrepEdge &NewEdge(int = -1 // 3d curve index
    );
    ON_BrepEdge &NewEdge(ON_BrepVertex &,            // start vertex
    ...
    */
    ON_BrepFace *NewFace(ON_Surface *pSurface, int vid[4], int eid[4],
                         ON_BOOL32 bRev3d[4]);
    ...
    Returns:
      ...
      not be created.
    */
    ON_BrepFace *NewRuledFace(const ON_BrepEdge &edgeA, bool bRevEdgeA,
    ...
    Returns:
      ...
      not be created.
    */
    ON_BrepFace *NewConeFace(const ON_BrepVertex &vertex,
                             const ON_BrepEdge &edge, bool bRevEdge);
    ...
    */
    ...
    See Also:
      ON_Brep::NewFace
    */
    ON_BrepLoop *NewOuterLoop(int face_index, int vid[4], int eid[4],
                              ON_BOOL32 bRev3d[4]);
    ...
    */
    bool NewPlanarFaceLoop(int face_index, ON_BrepLoop::TYPE loop_type,
    ...
    */
    ...
    See Also:
      ...
      ON_Brep::NewCurveOnFace
    */
    ON_BrepTrim &NewTrim(ON_BrepEdge &edge, ON_BOOL32 bRev3d, ON_BrepLoop &loop,
                         int c2i = -1);
    ...
    See Also:
      ON_Brep::NewTrim
    */
    ON_BrepTrim &NewSingularTrim(const ON_BrepVertex &vertex, ON_BrepLoop &loop,
                                 ON_Surface::ISO iso, int c2i = -1);
    ...
    */
    ON_BrepTrim &NewCurveOnFace(ON_BrepFace &face, ON_BrepEdge &edge,
                                ON_BOOL32 bRev3d = false, int c2i = -1);

    // appends a copy of brep to this and updates
    // indices of appended brep parts.  Duplicates are not removed.
    void Append(const ON_Brep & // brep
    );
    ...
    See Also:
      ON_Brep::SetTrimTypeFlags
    */
    ON_BrepTrim::TYPE TrimType(const ON_BrepTrim &trim,
    ...
    bool GetTrim2dStart(int trim_index, // index of ON_BrepTrim in m_T[] array
                        ON_2dPoint &) const;

    // GetTrim2dEnd() evaluates end of the
    // parameter space (2d) trim curve.
    bool GetTrim2dEnd(int, // index of ON_BrepTrim in m_T[] array
                      ON_2dPoint &) const;

    // GetTrim3dStart() evaluates the 3d surface at the start of the
    // parameter space (2d) trim curve.
    bool GetTrim3dStart(int, // index of ON_BrepTrim in m_T[] array
                        ON_3dPoint &) const;

    // GetTrim3dEnd() evaluates the 3d surface at the end of the
    // parameter space (2d) trim curve.
    bool GetTrim3dEnd(int, // index of ON_BrepTrim in m_T[] array
                      ON_3dPoint &) const;
    ...
    bool SetVertexTolerance(ON_BrepVertex &vertex,
                            ON_BOOL32 bLazy = false) const;
    virtual bool SetTrimTolerance(ON_BrepTrim &trim,
                                  ON_BOOL32 bLazy = false) const;
    virtual bool SetEdgeTolerance(ON_BrepEdge &edge,
                                  ON_BOOL32 bLazy = false) const;
    ...
    */
    virtual bool SetTrimBoundingBoxes(ON_BrepLoop &loop,
    ...
    Returns:
      ...
      boxes are valid.
    */
    virtual bool SetTrimBoundingBoxes(ON_BrepFace &face,
                                      ON_BOOL32 bLazy = false);
    ...
    */
    void SetTolerancesBoxesAndFlags(ON_BOOL32 bLazy = false,
    ...
    */
    ...
    Returns:
      ...
      this curve.
    */
    ON_Curve *Loop3dCurve(const ON_BrepLoop &loop,
    ...
    */
    int Loop3dCurve(const ON_BrepLoop &loop,
    ...
    */
    bool IsPointInside(ON_3dPoint P, double tolerance,
    ...
    bool SetTrimDomain(int, // index of trim in m_T[] array
                       const ON_Interval &);
    ...
    bool SetEdgeDomain(int, // index of edge in m_E[] array
                       const ON_Interval &);
    ...
    */
    ...
    See Also:
      ON_Brep::JoinEdges
    */
    bool CombineCoincidentEdges(
        ON_BrepEdge &,
        ON_BrepEdge &); // moves information to first edge and deletes second
    ...
    Remarks:
      ...
      the unused edges.
    */
    ON_BrepEdge *CombineContiguousEdges(int edge_index0, int edge_iindex1,
                                        double angle_tolerance_radians = ON_PI /
                                                                         180.0);
    ...
    void
    DeleteEdge(ON_BrepEdge &edge,
               ON_BOOL32 bDeleteEdgeVertices); // pass true to delete vertices
                                               // used only by edge
    void
    DeleteTrim(ON_BrepTrim &trim,
               ON_BOOL32 bDeleteTrimEdges); // pass true to delete edges and
                                            // vertices used only by trim
    void
    DeleteLoop(ON_BrepLoop &loop,
               ON_BOOL32 bDeleteLoopEdges); // pass true to delete edges and
                                            // vertices used only by trim
    void
    DeleteFace(ON_BrepFace &face,
               ON_BOOL32 bDeleteFaceEdges); // pass true to delete edges and
                                            // vertices used only by face
    ...
    */
    ...
    See Also:
      ON_Brep::GetConnectedComponents
    */
    int GetConnectedComponents(ON_SimpleArray<ON_Brep *> &components,
    ...
    */
    ON_Brep *SubBrep(int subfi_count, const int *sub_fi,
    ...
    ON_Brep *DuplicateFaces(int face_count, const int *face_index,
    ...
    */
    ...
    Parameters:
      edge_index - [in] index of edge to standardize.
      bAdjustEnds - [in] if true, move edge curve endpoints to vertices
      EdgeCurveUse - [in] if > 1, then the edge curve for this edge is used by
    more than one edge.  if 1, then the edge curve is used only for this edge.
    ...
    */
    ...
    Parameters:
      ...
      DisableSide - [in] This is a bit field.  A set bit indicates not to shrink
                  the surface on a given side.  The default of 0 enables
    shrinking on all four sides.
        @table
        value       meaning
    ...
    */
    ...
    int PrevTrim(int // index of current trim (m_trim_index)
    ) const;
    int NextTrim(int // index of current trim (m_trim_index)
    ) const;
    ...
    */
    ...
    identical), and they are joined along a set of edges that do not have any
    other faces, then this will combine the two faces into one. Parameters:
    ...
    */
    ...
    Returns:
      ...
      was removed.
    */
    bool RemoveNesting(bool bExtractSingleSegments, bool bEdges = true,
    ...
    */
    bool CollapseEdge(int edge_index, bool bCloseTrimGap = true,
                      int vertex_index = -1);
  ...
  protected:
    ...
    friend bool
    ON_BinaryArchive::ReadV1_TCODE_LEGACY_FAC(ON_Object **,
                                              ON_3dmObjectAttributes *);
    friend bool
    ON_BinaryArchive::ReadV1_TCODE_LEGACY_SHL(ON_Object **,
                                              ON_3dmObjectAttributes *);
    void Initialize();
    ...
    bool SwapLoopParameters(int // index of loop
    );
    bool SwapTrimParameters(int // index of trim
    );
    ...
    bool IsValidTrimTolerancesAndFlags(int trim_index,
    ...
    bool IsValidLoopTolerancesAndFlags(int loop_index,
                                       ON_TextLog *text_log) const;
    ...
    bool IsValidFaceTolerancesAndFlags(int face_index,
                                       ON_TextLog *text_log) const;
    ...
    bool IsValidEdgeTolerancesAndFlags(int edge_index,
                                       ON_TextLog *text_log) const;
    ...
    bool IsValidVertexTolerancesAndFlags(int vertex_index,
                                         ON_TextLog *text_log) const;
    ...
    bool ReadV1_LegacyTrimStuff(ON_BinaryArchive &, ON_BrepFace &,
                                ON_BrepLoop &);
...
*/
ON_DECL
ON_Brep *ON_BrepCylinder(const ON_Cylinder &cylinder, ON_BOOL32 bCapBottom,
                         ON_BOOL32 bCapTop, ON_Brep *pBrep = NULL);
...
*/
ON_DECL
ON_Brep *ON_BrepCone(const ON_Cone &cone, ON_BOOL32 bCapBottom,
                     ON_Brep *pBrep = NULL);
...
*/
ON_DECL
ON_Brep *ON_BrepRevSurface(ON_RevSurface *&pRevSurface, ON_BOOL32 bCapStart,
                           ON_BOOL32 bCapEnd, ON_Brep *pBrep = NULL);
...
*/
ON_DECL
ON_Brep *ON_BrepTrimmedPlane(const ON_Plane &plane, const ON_Curve &boundary,
                             ON_Brep *pBrep = NULL);
...
*/
ON_DECL
bool ON_BrepExtrude(ON_Brep &brep, const ON_Curve &path_curve,
                    bool bCap = true);
...
*/
ON_DECL
int ON_BrepExtrudeFace(ON_Brep &brep, int face_index,
                       const ON_Curve &path_curve, bool bCap = true);
...
*/
ON_DECL
int ON_BrepExtrudeLoop(ON_Brep &brep, int loop_index,
                       const ON_Curve &path_curve, bool bCap = true);
...
*/
ON_DECL
int ON_BrepExtrudeVertex(ON_Brep &brep, int vertex_index,
                         const ON_Curve &path_curve);
...
// Unlike ON_Brep::RemoveSlits(), this will remove slit pairs from a loop in
// cases that will result in the creation of more loops. Caller is responsible
// for calling ON_Brep::Compact() to get rid of deleted trims and loops.
...
*/
ON_DECL
ON_Brep *ON_MergeBreps(const ON_Brep &brep0, const ON_Brep &brep1,
                       double tolerance);
