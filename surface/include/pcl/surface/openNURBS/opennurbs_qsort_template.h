...
//    debugged This code is based ont the VC 2010 crt qsort.c file and must not
//    be released with public opennurbs.
...
#endif
    void
    ON_QSORT_FNAME(ON_SORT_TEMPLATE_TYPE *base, size_t num) {
