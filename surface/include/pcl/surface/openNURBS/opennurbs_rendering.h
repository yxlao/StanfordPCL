  ...
  public:
    ...
    */
    ...
    Returns:
      ...
      is one. Otherwise NULL is returned.
    */
    const ON_MappingChannel *MappingChannel(const ON_UUID &plugin_id,
    ...
    Returns:
      ...
      plug-in and channel.
    */
    bool AddMappingChannel(const ON_UUID &plugin_id, int mapping_channel_id,
    ...
    */
    ...
    bool DeleteMappingChannel(const ON_UUID &plugin_id,
                              const ON_UUID &mapping_id);
    ...
    */
    bool ChangeMappingChannel(const ON_UUID &plugin_id,
...
ON_DLL_TEMPLATE template class ON_CLASS
