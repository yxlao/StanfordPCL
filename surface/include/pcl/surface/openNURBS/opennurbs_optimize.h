...
ON_BOOL32 ON_FindLocalMinimum( // returns 0 - failed to converge, 1 - success, 2
                               // - failed to converge to requested tolerances
    int (*)(
        void *, double, double *,
    ...
    double,  // tol > 0 (minimum relative step size (use ON_EPSILON when in
             // doubt)
...
class ON_LocalZero1 {
  public:
    ...
    virtual ON_BOOL32 Evaluate( // returns true if successful
