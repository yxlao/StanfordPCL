...
class ON_CLASS ON_TextExtra : public ON_UserData {
  ...
  public:
    ...
    static ON_TextExtra *TextExtension(class ON_TextEntity2 *pDim,
                                       bool bCreate);
    static const ON_TextExtra *TextExtension(const class ON_TextEntity2 *pDim,
                                             bool bCreate);
    ...
    double m_border_offset; // Offset for the border around text to the
                            // rectangle used to draw the mask This number *
                            // HeightOfI for the text is the offset on each side
                            // of the tight rectangle around the text characters
...
class ON_CLASS ON_DimensionExtra : public ON_UserData {
  ...
  public:
    ...
    // of a detail view, this is the ratio of the page distance / model
    // distance. When the dimension text is displayed, the distance measured in
    // model space is multiplied by this number to get the value to display.
...
/*
  class ON_Annotation2
    ...
    Description:
      Used to serialize definitions of annotation objects (dimensions, text,
  leaders, etc.). Virtual base class for annotation objects Replaces
  ON_Annotation
*/
class ON_CLASS ON_Annotation2 : public ON_Geometry {
    ON_OBJECT_DECLARE(ON_Annotation2);

    // UNICODE symbol code to use for degrees, radius, diameter and plus/minus
    // in dimensions
    enum SYMBOLS {
        degreesym = 176,
        radiussym = L'R',
  ...
  public:
    ...
    */
    ...
    /*
      ...
      Returns:
        int -  The index (Get)
      Remarks:
        If the object is a text object the index is of object's font in the Font
      Table If the object is anything else, the index is of the object's
      dimstyle in the DimStyle Table Derived objects can use FontIndex() and
      StyleIndex() to set/get these same values.
    */
    int Index() const;
    void SetIndex(int);
    ...
    */
    ...
    /*
      ...
      Parameters:
        [in] ON::eAnnotationType type - dtDimLinear, dtDimAligned, dtDimAngular,
      etc. Returns: ON::eAnnotationType of the object
    */
    ...
    */
    ...
    /*
      ...
      Parameters:
        @untitled table
        [in] int index               index of the point to set in ECS 2d
      coordinates [in] const ON_2dPoint& pt    the new point value Returns:
    ...
    */
    ...
    /*
      ...
      "<>" Parameters: [in] const wchar_t* string   the new value for UserText
      Returns:
    ...
    */
    ...
    /*
      ...
      Remarks:
        This is the way the text is oriented with respect to the dimension line
      or screen: Above line, In LIne, Horizontal
    */
    ...
    */
    bool GetTextXform(ON_RECT gdi_text_rect, int gdi_height_of_I,
    ...
    */
    ...
    //    ON_Xform& text_xform  // output
    //    ) const;
    bool GetTextXform(const ON_RECT gdi_text_rect, const ON_Font &font,
    ...
    /*
      ...
      Returns:
        True if xform is set.
    */
    bool GetTextXform(ON_RECT gdi_text_rect, const ON_Font &font,
                      const ON_DimStyle &dimstyle, double dimscale,
...
class ON_CLASS ON_LinearDimension2 : public ON_Annotation2 {
  ...
  public:
    ...
    */
    ...
    bool CreateFromV2(const ON_Annotation &v2_ann,
    ...
    */
    int GetDimensionLineSegments(ON_RECT gdi_text_rect, int gdi_height_of_I,
                                 ON_Xform gdi_to_world,
                                 const ON_DimStyle &dimstyle, double dimscale,
                                 const ON_Viewport *vp, double a[6],
                                 bool &bInside) const;
    ...
    */
    ...
    /*
      ...
      Returns:
        ...
        false    Failure
    */
    bool CreateFromPoints(ON_3dPoint center, ON_3dPoint arrowtip,
...
class ON_CLASS ON_AngularDimension2 : public ON_Annotation2 {
  ...
  public:
    /*
      ...
      [1] = a point somewhere on the line from the center through the start
      point. The distance from center to [1] can be any value. [2] = a point
      somewhere on the line from the center through the end point. The distance
      from center to [2] can be any value. [3] = a point on the interior of the
      arc.  The distance from (0,0) to [3] is the radius of the arc.
    ...
    */
    ...
    /*
      ...
      Returns:
        ...
        false    Failure
    */
    bool CreateFromPoints(const ON_3dPoint &apex, const ON_3dPoint &p0,
                          const ON_3dPoint &p1, ON_3dPoint &arcpt,
                          ON_3dVector &Normal);
    ...
    */
    int GetDimensionArcSegments(ON_RECT gdi_text_rect, int gdi_height_of_I,
                                ON_Xform gdi_to_world,
                                const ON_DimStyle &dimstyle, double dimscale,
                                const ON_Viewport *vp, double a[6],
                                bool &bInside) const;
...
class ON_CLASS ON_OrdinateDimension2 : public ON_Annotation2 {
  ...
  public:
   ...
   [plane origin]
        ...
        The dimension lines are always drawn in the X or Y directions of the
   entity plane The distance represented by the dimension is measured from the
    ...
    */
    ...
    /*
      Description:
        Gets or sets the direction ( X or Y) that the ordinate dimension
      measures Returns: -1: direction determined by dim point and leader point
        0: measures parallel to the entity plane x axis
        1: measures parallel to the entity plane y axis
    */
    int Direction() const;
    ...
    */
    void CalcKinkPoints(ON_2dPoint p0, ON_2dPoint p1, int direction,
...
class ON_CLASS ON_TextEntity2 : public ON_Annotation2 {
  ...
  public:
    ...
    */
    ...
    // on each side of the tight rectangle around the text characters to the
    // mask rectangle.
    double MaskOffsetFactor() const;
    void SetMaskOffsetFactor(double offset);
...
class ON_CLASS ON_TextDot : public ON_Geometry {
  ...
  public:
    ...
    */
    ON_BOOL32 GetBBox(double *box_min, double *box_max,
