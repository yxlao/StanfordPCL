...
template <class T> class ON_SimpleArray {
  public:
    ...
    virtual void Remove(int); // Removes element. Uses memmove() to
    ...
    Returns:
      true if successful
    */
    bool Sort(ON::sort_algorithm sort_algorithm, int * /* index[] */,
    ...
    Returns:
      true if successful
    */
    bool Sort(ON::sort_algorithm sort_algorithm,
              int *, // index[]
              int (*)(const T *, const T *,
    ...
    virtual T *Realloc(T *, int); // (re)allocated capacity*sizeof(T) bytes
...
class ON_CLASS ON_2dPointArray : public ON_SimpleArray<ON_2dPoint> {
  public:
    // see ON_SimpleArray class definition comments for constructor
    // documentation
    ON_2dPointArray();
    ON_2dPointArray(int);
...
class ON_CLASS ON_3dPointArray : public ON_SimpleArray<ON_3dPoint> {
  public:
    ...
    bool Create(int point_dimension, int bRational, int point_count,
    ...
    bool GetBBox(double boxmin[3], double boxmax[3],
...
class ON_CLASS ON_2dVectorArray : public ON_SimpleArray<ON_2dVector> {
  public:
    ...
    bool GetBBox(double boxmin[2], double boxmax[2],
                 int bGrowBox = false) const;
...
class ON_CLASS ON_UuidPair {
  public:
    ...
    */
    static int CompareFirstUuid(const class ON_UuidPair *,
    ...
    */
    static int CompareSecondUuid(const class ON_UuidPair *,
                                 const class ON_UuidPair *);
...
*/
template <class T> int ON_CompareIncreasing(const T *a, const T *b);
...
*/
template <class T> int ON_CompareDecreasing(const T *a, const T *b);
