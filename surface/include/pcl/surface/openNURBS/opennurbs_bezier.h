...
class ON_CLASS ON_BezierCurve {
  public:
    ...
    bool Loft(int pt_dim, int pt_count, int pt_stride, const double *pt,
    ...
    */
    ...
    bool Rotate(double sin_angle, double cos_angle,
    ...
    // Remarks:
    //   Uses ON_BezierCurve::Transform() function to calculate the result.
    bool Rotate(double rotation_angle, const ON_3dVector &rotation_axis,
                const ON_3dPoint &rotation_center);
    ...
    // Returns:
    //   false if unable to evaluate.
    bool Ev1Der(double t, ON_3dPoint &point,
    ...
    // Returns:
    //   false if unable to evaluate.
    bool Ev2Der(double t, ON_3dPoint &point, ON_3dVector &first_derivative,
    ...
    */
    ...
    Returns:
      false if unable to evaluate.
    */
    bool EvCurvature(double t, ON_3dPoint &point, ON_3dVector &tangent,
    ...
    */
    ...
    bool Split(double t, ON_BezierCurve &left_side,
...
class ON_CLASS ON_BezierSurface {
  public:
    ...
    */
    ...
    ON_Interval Domain(int // 0 = "u" domain, 1 = "v" domain
    ) const;
    ...
    */
    ...
    ON_BezierCurve *IsoCurve(
        ...
        ON_BezierCurve *iso =
            NULL // When NULL result is constructed on the heap.
    ) const;
...
class ON_CLASS ON_BezierCage {
  public:
    ...
    Parameters:
      ...
      order2 - [in]
    */
    ON_BezierCage(const ON_BoundingBox &bbox, int order0, int order1,
                  int order2);
    ...
    Parameters:
      ...
      order2 - [in]
    */
    ON_BezierCage(const ON_3dPoint *box_corners, int order0, int order1,
                  int order2);
    ...
    */
    ...
    ON_Interval Domain(int // 0 = "u" domain, 1 = "v" domain, 2 = "w" domain
    ) const;
...
class ON_CLASS ON_BezierCageMorph : public ON_SpaceMorph {
  public:
    ...
    */
    bool Create(ON_3dPoint P0, ON_3dPoint P1, ON_3dPoint P2, ON_3dPoint P3,
