...
class ON_CLASS ON_Viewport : public ON_Geometry {
  ...
  public:
    ...
    */
    ...
    void Dump(ON_TextLog & // dump_target
    ) const;
    ...
    ON_BOOL32 Write(ON_BinaryArchive & // binary_archive
    ) const;
    ...
    */
    ...
    Remarks:
      ...
      are all equal, then no changes are made and true is returned.
    */
    bool ChangeToPerspectiveProjection(double target_distance,
    ...
    */
    bool ChangeToTwoPointPerspectiveProjection(double target_distance,
                                               ON_3dVector up,
                                               double lens_length);
    ...
    */
    ...
    bool GetCameraFrame(double *, // CameraLocation[3]
                        double *, // CameraX[3]
                        double *, // CameraY[3]
                        double *  // CameraZ[3]
    ) const;
    ...
    bool GetCameraExtents(
        // returns bounding box in camera coordinates - this is useful
        // information for setting view frustrums to include the point list
        ...
        int bGrowBox = false // set to true if you want to enlarge an existing
                             // camera coordinate box
    ) const;
    ...
    */
    bool SetFrustum(double left,      //
                    double right,     //   ( left < right )
                    double bottom,    //
                    double top,       //   ( bottom < top )
                    double near_dist, //
                    double far_dist //   ( 0 < near_dist < far_dist ) // ignored
                                    //   by Rhino version 1.0
    );
    ...
    */
    ...
    bool SetFrustumNearFar(const double *bboxmin, // 3d bounding box min
                           const double *bboxmax  // 3d bounding box max
    );
    bool SetFrustumNearFar(const double *center, // 3d bounding sphere center
                           double radius         // 3d bounding sphere radius
    );
    bool SetFrustumNearFar(double near_dist, // ( > 0 )
                           double far_dist   //
    );
    ...
    */
    bool ChangeToSymmetricFrustum(bool bLeftRightSymmetric,
    ...
    Returns:
      ...
      view frustum.
    */
    bool GetPointDepth(ON_3dPoint point, double *near_dist, double *far_dist,
    ...
    */
    ...
    Remarks:
      ...
      projection.
    */
    bool GetBoundingBoxDepth(ON_BoundingBox bbox, double *near_dist,
                             double *far_dist, bool bGrowNearFar = false) const;
    ...
    */
    bool GetSphereDepth(ON_Sphere sphere, double *near_dist, double *far_dist,
                        bool bGrowNearFar = false) const;
    ...
    */
    ...
    bool GetViewPlaneEquation(double view_plane_depth,
    ...
    */
    ...
    // Returns:
    //   true if camera and frustum are valid.
    bool GetNearRect(ON_3dPoint &left_bottom, ON_3dPoint &right_bottom,
                     ON_3dPoint &left_top, ON_3dPoint &right_top) const;
    ...
    // Returns:
    //   true if camera and frustum are valid.
    bool GetFarRect(ON_3dPoint &left_bottom, ON_3dPoint &right_bottom,
                    ON_3dPoint &left_top, ON_3dPoint &right_top) const;
    ...
    Returns:
      ...
      was calculated.  False otherwise.
    */
    bool GetViewPlaneRect(double view_plane_depth, ON_3dPoint &left_bottom,
    ...
    */
    bool SetScreenPort(int port_left, int port_right, int port_bottom,
                       int port_top, int port_near = 0, int port_far = 0);

    bool GetScreenPort(int *left,
    ...
    */
    ...
    bool
    SetCameraAngle(double half_smallest_angle // 1/2 of smallest subtended view
                                              // angle 0 < angle < pi/2
    );
    ...
    */
    bool GetFrustumLine(double screenx, double screeny,
                        ON_Line &world_line) const;

    // display tools
    bool GetWorldToScreenScale(
        const ON_3dPoint &point_in_frustum, // [in]  point in viewing frustum.
        double *pixels_per_unit // [out] scale = number of pixels per world unit
                                // at the 3d point
    ) const;

    bool GetCoordinateSprite(int, // size in pixels of coordinate sprite axes
    ...
    */
    double ClipCoordDepthBias(double relative_depth_bias, double clip_z,
                              double clip_w) const;
    ...
    */
    bool GetClipCoordDepthBiasXform(double relative_depth_bias,
                                    ON_Xform &clip_bias) const;
  ...
  protected:
    ...
    //   frustum is mapped to pixel coordinate
    //   (port_left,port_bottom,port_near). The point (right,top,-far), in
    //   camera coordinates, of the view frustum is mapped to pixel coordinate
    //   (port_right,port_top,port_far).
...
ON_DECL
bool ON_ViewportFromRhinoView( // create ON_Viewport from legacy Rhino
                               // projection info
