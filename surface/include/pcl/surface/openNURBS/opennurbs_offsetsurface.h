...
class ON_BumpFunction {
  public:
    ...
    void EvaluateHelperLinearBump(double t, double dt, int der_count,
                                  double *value) const;
    void EvaluateHelperQuinticBump(double t, double dt, int der_count,
                                   double *value) const;
};
...
class ON_CLASS ON_OffsetSurfaceFunction {
  public:
    ...
    */
    bool SetOffsetPoint(double s, double t, double distance,
                        double radius = 0.0);
...
class ON_CLASS ON_OffsetSurface : public ON_SurfaceProxy {
  ...
  public:
    ...
    ON_BOOL32 GetBBox(double *bbox_min, double *bbox_max,
