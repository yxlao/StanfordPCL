...
class ON_CLASS ON_Matrix {
  public:
    ...
    */
    ...
    bool IsValid() const;
    int IsSquare()
        const; // returns 0 for no and m_row_count (= m_col_count) for yes
    int RowCount() const;
    int ColCount() const;
    ...
    bool Create(int, // number of rows
    ...
    Remarks:
      ...
      will fail on a matrix created with this constructor.
    */
    bool Create(int row_count, int col_count, double **M,
    ...
    void SetDiagonal(
        const double *); // sets diagonal values and zeros off diagonal values
    void SetDiagonal(int,
                     const double *); // sets size to count x count and diagonal
                                      // values and zeros off diagonal values
    void SetDiagonal(
        const ON_SimpleArray<double> &); // sets size to length X lengthdiagonal
                                         // values and zeros off diagonal values
    ...
    bool Invert(double       // zero tolerance
    );
    ...
    */
    ...
    // See Also:
    //   ON_Matrix::BackSolve
    int RowReduce(double,         // zero_tolerance
                  double *,       // B
                  double * = NULL // pivot
    );
    ...
    // See Also:
    //   ON_Matrix::RowReduce
    bool BackSolve(double,         // zero_tolerance
                   int,            // Bsize
                   const double *, // B
                   double *        // X
    ) const;
...
*/
ON_DECL
bool ON_GetMatrixSVD(int row_count, int col_count, double const *const *A,
