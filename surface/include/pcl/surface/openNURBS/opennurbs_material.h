...
class ON_CLASS ON_Material : public ON_Object {
  ...
  public:
    ...
    */
    ...
    double m_index_of_refraction; // generally >= 1.0 (speed of light in
                                  // vacum)/(speed of light in material)
  ...
  public:
    ...
    */
    ...
    Returns:
      ...
      -1 if no match is found.
    */
    int FindTexture(const wchar_t *filename, ON_Texture::TYPE type,
                    int i0 = -1) const;
