...
BOOL APIENTRY DllMain(HANDLE hModule, DWORD ul_reason_for_call,
    ...
    case DLL_PROCESS_ATTACH:
        ::OutputDebugStringA(
            "OpenNURBS DllMain() ul_reason_for_call = DLL_PROCESS_ATTACH\n");
        ON_ClassId::IncrementMark(); // make sure each DLL that each process
                                     // that uses OpenNURBS has a unique mark.
        break;
