...
int ON_Color::Red() const { return m_color & 0xFF; }

int ON_Color::Green() const { return (m_color >> 8) & 0xFF; }

int ON_Color::Blue() const { return (m_color >> 16) & 0xFF; }

int ON_Color::Alpha() const { return (m_color >> 24) & 0xFF; }
...
void ON_Color::SetRGBA(int red, int green, int blue, int alpha) {
    if (red < 0)
        red = 0;
    else if (red > 255)
        red = 255;
...
void ON_Color::SetFractionalRGBA(double red, double green, double blue,
                                 double alpha) {
    int r, g, b, a;
    if (red < 0.0)
        red = 0.0;
