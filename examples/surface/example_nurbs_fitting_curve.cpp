...
void PointCloud2Vector2d(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud,
...
int main(int argc, char *argv[]) {
    ...
    if (argc > 1) {
        ...
        printf("  pcd-file    point-cloud file containing the boundary points "
               "(xy)\n");
        exit(0);
    }
    ...
    // #################### CURVE FITTING #########################
    ON_NurbsCurve curve = pcl::on_nurbs::FittingCurve2d::initNurbsCurve2D(
