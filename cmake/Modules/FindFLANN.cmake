...
find_path(FLANN_INCLUDE_DIR flann/flann.hpp
          HINTS ${PC_FLANN_INCLUDEDIR} ${PC_FLANN_INCLUDE_DIRS} "${FLANN_ROOT}" "$ENV{FLANN_ROOT}" "${FLANN_ROOT}/include"
...
find_library(FLANN_LIBRARY
             ...
             HINTS ${PC_FLANN_LIBDIR} ${PC_FLANN_LIBRARY_DIRS} "${FLANN_ROOT}" "$ENV{FLANN_ROOT}" "${FLANN_ROOT}/lib" "${FLANN_ROOT}/lib64"
             PATHS "$ENV{PROGRAMFILES}/Flann" "$ENV{PROGRAMW6432}/Flann"
	     PATH_SUFFIXES lib)
...
find_library(FLANN_LIBRARY_DEBUG
	     ...
	     PATHS "$ENV{PROGRAMFILES}/Flann" "$ENV{PROGRAMW6432}/Flann"
	     PATH_SUFFIXES lib)
message(STATUS "FLANN_LIBRARY_DEBUG: ${FLANN_LIBRARY_DEBUG}")
