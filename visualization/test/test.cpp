...
int main(int argc, char **argv) {
    ...
    // Handler random color demo
    {
        ...
        p.addPointCloud<Point>(
            cloud, "cloud_random"); // no need to add the handler, we use a
                                    // random handler by default
        p.spin();
    ...
    // Handler custom demo
    {
        ...
        pcl::visualization::PointCloudColorHandlerCustom<Point> handler(
            cloud, 255, 0, 0);
        ...
        handler = pcl::visualization::PointCloudColorHandlerCustom<Point>(
            cloud, 255, 0, 0);
    ...
    // Handler RGB demo
    {
        ...
        pcl::visualization::PointCloudColorHandlerRGBField<Point> handler(
            cloud);
    ...
    // Handler generic field demo
    {
        ...
        pcl::visualization::PointCloudColorHandlerGenericField<Point> handler_z(
            cloud, "z");
        pcl::visualization::PointCloudColorHandlerGenericField<Point> handler_x(
            cloud, "x");
