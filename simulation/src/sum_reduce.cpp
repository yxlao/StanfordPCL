...
pcl::simulation::SumReduce::SumReduce(int width, int height, int levels)
    ...
    for (int i = 0; i < levels_; ++i) {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_R32F, level_width, level_height, 0,
...
void pcl::simulation::SumReduce::sum(GLuint input_array, float *output_array) {
