...
int pcl::simulation::gllib::Program::getUniformLocation(
    const std::string &name) {
    return glGetUniformLocation(program_id_, name.c_str());
}

void pcl::simulation::gllib::Program::setUniform(const std::string &name,
...
bool pcl::simulation::gllib::Program::addShaderText(const std::string &text,
...
bool pcl::simulation::gllib::Program::addShaderFile(const std::string &filename,
                                                    ShaderType shader_type) {
...
bool pcl::simulation::gllib::Program::link() {
...
void pcl::simulation::gllib::Program::use() { glUseProgram(program_id_); }
...
void pcl::simulation::gllib::printShaderInfoLog(GLuint shader) {
    GLsizei max_length;
    GLsizei length;
    GLchar *info_log;
...
void pcl::simulation::gllib::printProgramInfoLog(GLuint program) {
    GLsizei max_length;
    GLsizei length;
    GLchar *info_log;
...
Program::Ptr pcl::simulation::gllib::Program::loadProgramFromText(
...
Program::Ptr pcl::simulation::gllib::Program::loadProgramFromFile(
